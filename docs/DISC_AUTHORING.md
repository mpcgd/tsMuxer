...
These multi-layer (BD-R/RE DL and BD-R XL) authoring features were contributed by
teaching-droid/tsMuxer. All of them are opt-in; the default behaviour is unchanged.
